...
export function indexerFixtures() {
  return [
    ...
    fixture("sales", a.getSaleEncoder(), { ...base, version: 2, saleApproval: address("SysvarC1ock11111111111111111111111111111111"), applicationHash: hash, shareClass: key, mint: key, paymentMint: key, proceeds: key, authority: key, saleId: BigInt(3), pricePerUnit: BigInt(50), totalForSale: BigInt(100), sold: BigInt(7), startTs: BigInt(1), endTs: BigInt(2), status: 1, raiseType: 0, cliffMonths: 0, vestingMonths: 0 }),
    fixture("custody_vaults", a.getCustodyVaultEncoder(), { ...base, version: 2, kycRegistry: address("SysvarC1ock11111111111111111111111111111111"), shareClass: key, mint: key, escrow: key, vaultId: BigInt(4), authority: key, vaultType: 0, realizeAction: 0, amount: BigInt(55), state: 0, deadline: BigInt(77), metadataHash: hash, beneficiary: key, deposited: BigInt(33) }),
