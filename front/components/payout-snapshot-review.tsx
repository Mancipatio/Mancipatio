...
export function PayoutSnapshotReview({ vault, currentRound, legacy = false }: { vault: string; currentRound: bigint; legacy?: boolean }) {
  ...
  const [restoreKind, setRestoreKind] = useState<PayoutSnapshotKind>(legacy ? "legacy_vault_vote" : "vault_vote");
