// Minimal inline icon set, lucide-style stroke=1.6. No external dependency.
// Every icon is a 16x16 (default) SVG with currentColor stroke so it picks
// up text colour from its container.
