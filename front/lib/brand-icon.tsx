...
export async function brandIcon(size: number) {
  const mark = await readFile(join(process.cwd(), "public/brand/manci-mark.png"));
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#082c23", borderRadius: size * 0.22 }}>
      ...
      <img src={`data:image/png;base64,${mark.toString("base64")}`} alt="" width={size * 0.72} height={size * 0.72 * 442 / 622} />
    </div>,
