...
export type ApproverAdminRecordSeeds = {
  approvedBy: Address;
};

export async function findApproverAdminRecordPda(
  seeds: ApproverAdminRecordSeeds,
  ...
  return await getProgramDerivedAddress({
    ...
    seeds: [
      ...
      getAddressEncoder().encode(seeds.approvedBy),
    ],
  });
}
