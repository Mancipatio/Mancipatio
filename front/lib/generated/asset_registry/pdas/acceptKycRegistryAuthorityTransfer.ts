...
export type AcceptKycRegistryAuthorityTransferSeeds = {
  kycRegistry: Address;
};

export async function findAcceptKycRegistryAuthorityTransferPda(
  seeds: AcceptKycRegistryAuthorityTransferSeeds,
