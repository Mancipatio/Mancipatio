...
export type CreateKycRegistryAdminRecordSeeds = {
  adminAuthority: Address;
};

export async function findCreateKycRegistryAdminRecordPda(
  seeds: CreateKycRegistryAdminRecordSeeds,
  ...
  return await getProgramDerivedAddress({
    ...
    seeds: [
      ...
      getAddressEncoder().encode(seeds.adminAuthority),
    ],
  });
}
