// Securities Commission approval as shown to the public (whitepaper board and
// asset page). A whitepaper counts as approved only when the platform recorded
...
export const SSC_NOT_APPROVED_LABEL = "Not approved by the Securities Commission";
